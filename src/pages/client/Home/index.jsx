          ...
          <div className="container">
            ...
            <div className="counter-container">
              <div className="counter">
                <h3 className="text-dark" data-target="2500" ref={saleCount}>
                  0
                </h3>
                <span className="text-dark-50">Homes For Sale</span>
              </div>
              <div className="counter">
                <h3 className="text-dark" data-target="3000" ref={soldCount}>
                  0
                </h3>
                <span className="text-dark-50">Homes Recently Sold</span>
              </div>
              <div className="counter">
                <h3 className="text-dark" data-target="2100" ref={priceCount}>
                  0
                </h3>
